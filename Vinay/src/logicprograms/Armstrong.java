...
{
	//Armstrong number means sum of power of its digits should be equal to the given number
	//Plus Perfect number, Narcissistic number, Pluperfect digital invariant (PPDI)
